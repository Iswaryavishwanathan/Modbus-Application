...
public class ModbusController {
    ...
    /**
     * 🔹 API to read registers dynamically from the frontend
     */
    //    @PostMapping(value = "/upload", consumes = "application/octet-stream")
    // public ResponseEntity<String> receiveBinary(@RequestBody byte[] data) {
    //     System.out.println("📥 Received binary data of length: " + data.length);
        
    //     // Optionally, print timestamp and values
