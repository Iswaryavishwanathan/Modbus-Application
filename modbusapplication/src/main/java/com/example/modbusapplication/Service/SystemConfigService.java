...
public class SystemConfigService {
            ...
            if (encByteString != null) {
                ...
                try (ObjectInputStream ois = new ObjectInputStream(new ByteArrayInputStream(data))) {
                    ...
                    if (obj instanceof SystemConfig) {
                        ...
                        System.out.println("Deserialized object is not of type SystemConfig.");
                    }
                }
            } else {
    ...
    public void updateSystemConfig(SystemConfig systemConfig,SystemConfig systemConfigExcistingData){
        ...
        if (systemConfig.getDeviceId() == null || systemConfig.getDeviceId()=="") {
            systemConfig.setDeviceId(systemConfigExcistingData.getDeviceId());
        }
    ...
    public boolean updateWifiNetplan(SystemConfig systemConfig) {
        try {
            ...
            System.err.println("Error updating Mock Netplan config: " + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
